package com.net.jpcap.capture;

import com.net.jpcap.classify.*;
import com.net.jpcap.entity.PacketInfo;
import com.net.jpcap.utils.BytesUtil;
import jpcap.packet.*;
...
public class Analyse {
	...
	public PacketInfo getDetail(Packet p){
		...
		info.setContent(BytesUtil.bytes2HexWithBlank(p.data,true));
		return info;
	}
